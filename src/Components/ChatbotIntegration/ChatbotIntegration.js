    ...
    <div>
      ...
      <div className="integration-main-container">
        <div className="integration-section">
          <a
            href={"https://shubham00712.github.io/BeyondChatsAssignment/#/client-website-test"}
            target="_blank"
            rel="noreferrer"
          >
        ...
        <div className="integration-section">
          <a
            href={"https://shubham00712.github.io/BeyondChatsAssignment/#/chatbot-integration-result"}
            target="_blank"
            rel="noreferrer"
          >
